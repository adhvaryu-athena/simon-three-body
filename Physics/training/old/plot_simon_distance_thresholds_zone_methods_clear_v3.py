"""
plot_simon_distance_thresholds_zone_methods_clear_v3.py
...
Run:
    python plot_simon_distance_thresholds_zone_methods_clear_v3.py

Outputs:
    simon_distance_thresholds_zone_methods_clear_v3.png
    simon_distance_thresholds_zone_methods_clear_v3.pdf
"""
...
# Revised Zone 2: no trajectory training; use exact force with sub-stepping.
draw_range(
    ax_bottom,
    ZONE2_START,
    ZONE2_END,
...
out_png = "simon_distance_thresholds_zone_methods_clear_v3.png"
out_pdf = "simon_distance_thresholds_zone_methods_clear_v3.pdf"
