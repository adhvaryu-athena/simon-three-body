...
def main():
    ...
    for dt in DT_VALUES:
        ...
        while n_ok < N_PER_DT:
            ...
            try:
                x_ref, _ = ias15_one_step_isolated(x0, v0, m, dt)
            ...
            try:
                ...
                # Defensive conversion: find_c_opt should return three scalar floats.
                # If a malformed value appears, reject this IC rather than killing the run.
                c_opt  = float(c_opt)
