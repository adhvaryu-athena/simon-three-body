...
def _mse(a, b):
    ...
    Avoids NumPy reductions completely because Windows access violations
    were occurring inside np.sum / np.all during bad trial-c evaluations.
