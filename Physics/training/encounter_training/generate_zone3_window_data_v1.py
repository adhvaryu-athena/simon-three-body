"""
generate_zone3_window_data_v1.py  --  Zone 3 short-window trajectory data
...
Recommended first test:
    python -B generate_zone3_window_data_v1.py --dt 0.08 --n 5 --batch 1 --mode mixed --window_years 0.5 --window_samples 21

Recommended real batches after the test:
    python -B generate_zone3_window_data_v1.py --dt 0.04 --n 50 --batch 101 --mode mixed --window_years 0.5 --window_samples 21
    python -B generate_zone3_window_data_v1.py --dt 0.08 --n 50 --batch 101 --mode mixed --window_years 0.5 --window_samples 21
    python -B generate_zone3_window_data_v1.py --dt 0.10 --n 50 --batch 101 --mode mixed --window_years 0.5 --window_samples 21
"""
...
def build_arg_parser():
    ...
    ap.add_argument("--prefix", default="encounter_data_zone3_window_v1",
                    help="Output filename prefix")
    ap.add_argument("--timeout", type=float, default=IAS15_TIMEOUT_SEC,
                    help="IAS15 subprocess timeout per candidate state")
...
def main():
    ...
    print("=" * 78)
    print("ZONE 3 SHORT-WINDOW TRAJECTORY DATA GENERATOR v1")
    print(f"  dt             : {dt:.6f} yr")
    ...
    while n_ok < n_target and n_try < max_tries:
        ...
        try:
            ref_times, ref_pos = ias15_window_isolated(
                x0, v0, m, float(args.window_years), int(args.window_samples), timeout=float(args.timeout)
            )
    ...
    with open(summary_file, "w", encoding="utf-8") as fh:
        fh.write("ZONE 3 SHORT-WINDOW TRAJECTORY DATASET SUMMARY v1\n")
        fh.write("=" * 78 + "\n")
        fh.write(f"dt             : {dt:.6f}\n")
